  ...
  <div id="image-editor" :style="imageEditorSty">
    ...
    <div class="toolbar-wrapper" :style="toolWrapperSty">
      <div class="toolbar funcbar" :style="funcSty">
        <div class="menu">
          ...
          <a @click="toggleBlur"><i class=" el-icon-refresh"></i>旋转</a>
          <!-- <a @click="toggleZoom"><i class=" el-icon-view"></i>缩放</a> -->
      ...
      <div class="toolbar enhance text-enhance" :style="enhanceSty" v-show="showText">
        <div class="menu">
          ...
          <label>
            颜色
            <input type="text" readonly="true" @click="toggleColorPicker" :style="colorInputSty"
          ...
          <label>
            阴影颜色
            <input type="text" readonly="true" @click="toggleShadowColorPicker" :style="shadowColorInputSty"
              class="color-picker-input" />
      ...
      <div class="toolbar enhance figure-enhance" :style="enhanceSty" v-show="showFigure">
        <div class="menu">
          ...
          <label>
            颜色
            <input type="text" readonly="true" @click="toggleFigureColorPicker" :style="colorFigureInputSty"
              class="color-picker-input" />
    ...
    <div class="panel" :style="editSty">
      ...
      <div class="mask" :style="editSty" @drop.prevent="drop" @click="maskClick">
        ...
        <Box :show="showMosaic" :width="mosaicW" :height="mosaicH" :left="mosaicL" :top="mosaicT"
          :borderW="mosaicBorderW" :canvasW="canvasW" :canvasH="canvasH" :canDrag="mosaicCanDrag" :canvas="$refs.canvas"
          @change="mosaicChange">
          <div :style="mosaicSty"></div>
        </Box>
        <Box :show="showFigure" :width="figureW" :height="figureH" :left="figureL" :top="figureT"
          :borderW="figureBorderW" :canvasW="canvasW" :canvasH="canvasH" :canDrag="figureCanDrag" :canvas="$refs.canvas"
          @change="figureChange">
